namespace Lab2_Ca4
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            txtKHoaNam = new TextBox();
            txtPhone_number = new TextBox();
            txtKhoaID = new TextBox();
            label2 = new Label();
            label5 = new Label();
            bSAVE = new Button();
            bEDIT = new Button();
            ...
            // txtKHoaNam
            // 
            txtKHoaNam.Location = new Point(360, 16);
            txtKHoaNam.Name = "txtKHoaNam";
            txtKHoaNam.Size = new Size(156, 23);
            txtKHoaNam.TabIndex = 1;
            // 
            // txtPhone_number
            // 
            txtPhone_number.Location = new Point(360, 49);
            txtPhone_number.Name = "txtPhone_number";
            txtPhone_number.Size = new Size(156, 23);
            txtPhone_number.TabIndex = 4;
            txtPhone_number.TextChanged += txtGPA_TextChanged;
            txtPhone_number.KeyPress += txtGPA_KeyPress;
            // 
            // txtKhoaID
            // 
            txtKhoaID.AcceptsReturn = true;
            txtKhoaID.Location = new Point(89, 16);
            txtKhoaID.Name = "txtKhoaID";
            txtKhoaID.Size = new Size(156, 23);
            txtKhoaID.TabIndex = 0;
            // 
            // label2
            // 
            ...
            grp1.Controls.Add(txtKHoaNam);
            grp1.Controls.Add(txtPhone_number);
            grp1.Controls.Add(txtKhoaID);
        ...
        private TextBox txtKHoaNam;
        private TextBox txtPhone_number;
        private TextBox txtKhoaID;
